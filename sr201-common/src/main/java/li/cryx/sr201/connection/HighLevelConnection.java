...
public class HighLevelConnection implements Closeable {
	...
	/**
	 * Query the relays for their current states.
	 *
	 ...
	 *
	 * @param channel
	 *            Indicates which relay should switch. Also supports special
	 ...
	 * @return Map of channels and associated states.
	 * @throws ConnectionException
	 *             is thrown if the command could not be executed correctly.
	 */
